...
PRIMAL_TASKS["gfootball"]= 'gfootball_0'
...
class Workspace:
    def __init__(self, cfg):
        ...
        #                          cfg.action_repeat, cfg.seed)
        # self.train_env = Academy_3_vs_1_with_Keeper(no_reward=True)
        self.eval_env = None
    ...
    def train(self):
        ...
        while train_until_step(self.global_step):
            ...
            if (self.global_frame - self.last_snapshoot) > self.cfg.snapshot_interval:
                self.save_snapshot()
                self.last_snapshoot = self.global_frame
...
@hydra.main(config_path='.', config_name='pretrain_football')
def main(cfg):
